...
namespace VerCon
{
    class Program
    {
                    ...
                    case "init": //инициализация папки
                        {
                            ...
                            if (initfile.Exists)
                            {
                                Console.WriteLine("Папка уже проиницилизированна!");
                            }
                            else
                            {
                    ...
                    case "add"://добавить файл
                        {
                            if (folder.Initialized == true)
                            {
                                ...
                                for (int i = 0; i < folder.Files.Count; i++)
                                {
                                    ...
                                    if (folder.Files[i].Name == arg[1])
                                    {
                                        Console.WriteLine("Файл уже добавлен");
                                        t = 1;
                                        break;
                                    }
        ...
        public static void ProcessFile(string path, StreamWriter writer)//собрать инфу
        {
        ...
        {
            FileStream file = new FileStream(dirPath + "test.txt", FileMode.OpenOrCreate, FileAccess.Write); 
